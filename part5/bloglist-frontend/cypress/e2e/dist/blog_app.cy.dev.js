...
describe('Blog app', function () {
  ...
  describe('Login', function () {
    it('succeeds with correct credentials', function () {
      ...
      cy.get('#password').type('salainen'); // cy.contains('login').click()
    ...
    describe('when logged in', function () {
      ...
      it('one of those can be be deleted', function () {
        ...
        cy.get('.success').should('contain', 'Deleted blog').and('have.css', 'color', 'rgb(0, 128, 0)');
      });
      it('blog can not be deleted by another user', function () {
        ...
        cy.contains('Title: TestTitle1').parent().contains('Delete').as('deleteButton');
        cy.get('@deleteButton').click();
        cy.get('.error').should('contain', 'Unauthorized').and('have.css', 'color', 'rgb(255, 0, 0)');
      });
      describe('liking blogs', function () {
        it('a blog can be liked', function () {
          ...
          cy.get('.success').should('contain', "You liked 'TestTitle1'").and('have.css', 'color', 'rgb(0, 128, 0)');
        });
