...
if (process.env.NODE_ENV === 'test') {
  var testingRouter = require('./controllers/testing'); // const notesRouter = require('./controllers/notes')
  // const usersRouter = require('./controllers/users')
  // const loginRouter = require('./controllers/login')


  app.use('/api/testing', testingRouter); // app.use('/api/notes', notesRouter)
  // app.use('/api/users', usersRouter)
  // app.use('/api/login', loginRouter)
}
...
module.exports = app; //Cypress Test
